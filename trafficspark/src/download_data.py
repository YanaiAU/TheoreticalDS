...
PACKAGE = "https://data.gov.il/dataset/02789da8-7a3e-4bfc-b771-1732b1cf403c"
...
def _fetch_all(rid: str, page: int = 32000) -> tuple[list[str], list[dict]]:
    ...
    while True:
        ...
        req = urllib.request.Request(url, headers={"User-Agent": "TrafficSpark/1.0 (course project)"})
